...
namespace QLSV
{
    public partial class frm_sinhvien : Form
    {
        ...
        {
            // Tải danh sách lớp trước để combobox có dữ liệu
            LoadLopCombo();
        ...
        private void LoadLopCombo()
        {
            ...
            {
                MessageBox.Show("Lỗi khi tải danh sách lớp:\n" + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private tbl_sinhvien GetSinhVienFromForm()
        {
            ...
            return new tbl_sinhvien
            {
                ...
                // ưu tiên SelectedValue (MaLop), nếu null thì fallback về Text
                malop    = (cboLop.SelectedValue as string) ?? cboLop.Text
            };
        }
        ...
        private void dgvSinhVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cboLop.Text        = row.Cells["malop"].Value?.ToString()?.Trim();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (sv == null) return;
            sv.malop = (string)(cboLop.SelectedValue ?? sv.malop);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sv.malop    = (string)(cboLop.SelectedValue ?? cboLop.Text.Trim());
        ...
        {
            // Không cần nạp lại datasource khi thay đổi chọn
        }
